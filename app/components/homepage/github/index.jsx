            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
                    {stats.map((stat) => (
                        ...
                        >
                            <div className="h-full w-full rounded-lg border border-[#0f1565] bg-gradient-to-r to-[#00054b] from-[#060d29] shadow-none hover:border-[#2c56ef] transition-all duration-500 p-4">
                    ...
                    <div className="w-full max-w-6xl p-3 rounded-lg border border-[#0f1565] bg-gradient-to-r to-[#000216]/75 from-[#030921]/75 shadow-none hover:border-[#249eea] transition-all duration-500">
                        ...
                        <div className="p-4 flex justify-center">
                            <GitHubCalendar
                                ...
                                blockMargin={4}
                                theme={{
                                    light: ['#00054b', '#0353a4', '#00b4d8', '#90e0ef', '#caf0f8'],
