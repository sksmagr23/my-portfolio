...
function ProjectCard({ project }) {
  return (
    <div className="from-[#040819] border-[#1c3aa5a0] to-[#00054b] relative rounded-lg border glass-panel bg-gradient-to-r w-full shadow-xl shadow-sky-800/20 drop-shadow-md mx-4">
      ...
      <div className="px-4 lg:px-8 py-3 lg:py-5 relative">
        ...
        <p className="text-center ml-12 text-[#c8a951] text-base lg:text-xl font-medium">
          {project.name}
        </p>
      </div>
        ...
        <code className="text-xs md:text-sm lg:text-base font-mono">
          ...
          <div>
            ...
            <a 
              ...
              className="text-indigo-300 hover:text-[#c8a951] transition-colors duration-300 inline-flex items-center gap-1"
            >
