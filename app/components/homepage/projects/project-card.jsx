...
function ProjectCard({ project }) {
  return (
    <div className=" border-[#1c3aa5ce] relative border-2 glass-panel w-full shadow-xl shadow-sky-800/20 drop-shadow-md mx-4">
      <div className="flex flex-row">
        <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-[#2cdfff] to-[#4de50192]"></div>
      </div>
      ...
      <div className="px-4 lg:px-8 py-3 lg:py-5 relative">
        ...
        <p className="text-center ml-12 text-[#76e521] text-base lg:text-xl font-medium">
          {project.name}
        </p>
      </div>
