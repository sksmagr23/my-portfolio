...
function ProjectCard({ project }) {
  return (
    <div className="border-[#1c3aa5ce] relative border-2 w-full shadow-xl shadow-sky-800/20 drop-shadow-lg rounded-md glass-panel">
      <div className="flex flex-row">
        <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-[#64ffb9a9] to-transparent"></div>
      </div>
      
      <div className="px-4 lg:px-6 py-2 lg:py-4 relative">
      ...
      <div className="overflow-hidden border-t border-indigo-900/30 px-3 lg:px-6 py-4 lg:py-6 text-xs md:text-base">
          ...
          <div className="ml-4 lg:ml-8 mr-2">
            ...
            <span className="text-yellow-100">{' ' + project.description}</span>
            <span className="text-gray-400">,</span>
          </div>
