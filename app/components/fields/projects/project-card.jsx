...
function ProjectCard({ project }) {
  return (
    <div className=" border-[#1c3aa5ce] relative border-2 glass-panel w-full shadow-xl shadow-sky-800/20 drop-shadow-md rounded-md">
      <div className="flex flex-row">
        <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-[#4de50192] to-transparent"></div>
      </div>
      ...
      <div className="px-4 lg:px-8 py-3 lg:py-5 relative">
        ...
        <p className="text-center ml-12 text-[#9ae521] text-base lg:text-xl font-medium">
          {project.name}
        </p>
      </div>
      ...
      <div className="overflow-hidden border-t border-indigo-900/30 px-4 lg:px-8 py-4 lg:py-8">
        <code className="text-xs md:text-sm lg:text-base font-mono">
          <div>
            <span className="mr-2 text-lime-300">const</span>
          ...
          <div>
            ...
            <a 
              ...
              className="text-indigo-300 hover:text-[#6dd51e] transition-colors duration-300 inline-flex items-center gap-1"
            >
