            ...
            <div className="card-highlight relative rounded-xl overflow-hidden transition-all duration-300 shadow-[10px_10px_8px_#002855]">
              <div className="from-[#0b0d31] border-[#1c3aa5a0] relative rounded-xl border bg-gradient-to-b to-transparent transition-all duration-200">
                ...
                <div className="border-t border-blue-900/50 text-xs md:text-base px-4 lg:px-6 py-5 lg:py-6">
                  ...
                  <div>
                    <span className="ml-4 lg:ml-6 mr-2 text-white">role:</span>
                    <span className="text-[#c8a951]">{`'`}</span>
                    <span className="text-cyan-300">Full Stack Software Developer</span>
                    <span className="text-[#c8a951]">{`',`}</span>
                  </div>
                  <div>
                    <span className="ml-4 lg:ml-6 mr-2 text-white">contact:</span>
                    <span className="text-[#c8a951]">{`'`}</span>
                    <span className="text-cyan-300">sakshamag34@gmail.com</span>
                    <span className="text-[#c8a951]">{`',`}</span>
                  </div>
                  <div>
                    <span className="ml-4 lg:ml-6 mr-2 text-white">location:</span>
                    <span className="text-[#c8a951]">{`'`}</span>
                  ...
                  <div>
                    <span className="ml-4 lg:ml-6 mr-2 text-white">openToWork:</span>
                    <span className="text-green-400">true</span>
                    <span className="text-gray-400">,</span>
                  </div>
                  <div>
                    <span className="ml-4 lg:ml-6 mr-2 text-white">quickLearner:</span>
                    <span className="text-green-400">true</span>
                    <span className="text-gray-400">,</span>
                  </div>
                  <div>
                    <span className="ml-4 lg:ml-6 mr-2 text-white">caffeineLevel:</span>
                    <span className="text-[#c8a951]">{`'`}</span>
                    <span className="text-cyan-300">High ☕</span>
                    <span className="text-[#c8a951]">{`',`}</span>
                  </div>
                  <div>
                    <span className="ml-4 lg:ml-6 mr-2 text-white">routine:</span>
                    <span className="text-[#c8a951]">{`'`}</span>
