    ...
    <div className="relative border-t bg-[#07173c] border-[#4f5a99] text-white">
      <div className="mx-auto px-4 sm:px-8 lg:max-w-[70rem] xl:max-w-[76rem] 2xl:max-w-[92rem] py-4 lg:py-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm">
            © Tech Portfolio by <Link target="_blank" href="https://github.com/sksmagr23" className="text-[#78d719]">Saksham Agrawal</Link>
          </p>
          <div className="flex items-center">
            <Link
              target="_blank"
              href="https://github.com/sksmagr23/my-portfolio"
              className="flex items-center gap-2 uppercase hover:text-[#78d719]"
            >
              <IoStar />
              <span>Star</span>
            </Link>
